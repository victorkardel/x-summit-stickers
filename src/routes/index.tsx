...
function App() {
  ...
  const progressPercentage = (collectedCount / STICKERS.length) * 100;
  ...
  return (
    <div className="h-screen flex flex-col bg-black overflow-x-hidden">
      ...
      <main
        ref={mainContentRef}
        className="flex-1 overflow-y-auto pb-0 relative"
      >
      ...
      <nav className="sticky bottom-0 z-10 bg-black border-t border-gray-800 shadow-lg">
        <div className="grid grid-cols-3">
          ...
          >
            ...
            <span
              className={`text-xs mt-0.5 ${
                activeTab === "repeated" ? "text-yellow-500" : "text-gray-500"
              }`}
            >
              {repeatedCount}
            </span>
